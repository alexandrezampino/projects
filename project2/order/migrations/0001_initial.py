# Generated by Django 3.0.2 on 2020-03-24 13:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='order.Product_type')),
            ],
        ),
        migrations.CreateModel(
            name='Payment_terms',
            fields=[
                ...
                ('type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='order.Payment_terms_choices')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('invoice_number', models.CharField(default='Inv-01', max_length=50)),
                ...
                ('payment_terms', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.PROTECT, to='order.Payment_terms')),
